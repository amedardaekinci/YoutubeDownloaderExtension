    ...
    <div class="video-item">
      ...
      <div class="download-buttons">
        ...
        <button class="download-btn mp3-btn" id="mp3Btn">
          <span class="download-icon"></span>
          <span class="format">M4A</span>
          <span class="type">
            <span class="main">(better mp3)</span>
            <span class="sub">(voice)</span>
          </span>
        </button>
      </div>
      <div class="quality-info">
        MP4: 1080p • M4A: 256kbps
      </div>
    </div>
  `;
    ...
    mp4Btn.addEventListener('click', async () => {
      ...
      try {
        ...
        setTimeout(async () => {
          ...
          mp4Btn.innerHTML = '<span class="download-icon"></span><span class="format">MP4</span><span class="type">(video)</span>';
    ...
    mp3Btn.addEventListener('click', async () => {
      ...
      try {
        ...
        setTimeout(async () => {
          ...
          mp3Btn.innerHTML = '<span class="download-icon"></span><span class="format">M4A</span><span class="type"><span class="main">(better mp3)</span><span class="sub">(voice)</span></span>';
          mp3Btn.disabled = false;
          mp4Btn.disabled = false;
          isDownloading = false;
        }, 10000);
